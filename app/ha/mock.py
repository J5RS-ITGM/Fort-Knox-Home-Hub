...
SEED: list[dict[str, Any]] = [
    ...
    {"entity_id": "cover.garage_door_opener", "state": "closed",
     "attributes": {"friendly_name": "Garage Door Opener", "device_class": "garage"}},
...
class MockHA:
    ...
    async def call_service(self, domain: str, service: str, entity_id: str, data: dict[str, Any]) -> None:
        ...
        if domain in ("switch", "light"):
            ...
            # garage door opener: settle instantly in mock (no opening state)
