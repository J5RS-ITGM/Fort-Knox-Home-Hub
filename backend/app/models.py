...
class Recipe(Base):
    ...
    servings: Mapped[str] = mapped_column(String(40), nullable=False, default="")
    prep_time: Mapped[str] = mapped_column(String(40), nullable=False, default="")
    ingredients: Mapped[str] = mapped_column(Text, nullable=False, default="")  # one per line
